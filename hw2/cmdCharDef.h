...
#define TA_ARROW_KEY_FLAG   (1 << 8)//10000000=256
...
#define TA_MOD_KEY_FLAG     (1 << 9)//512
...
enum ParseChar
{
   ...
   //
   // -- Arrow keys: 27 -> 91 -> {UP=65, DOWN=66, RIGHT=67, LEFT=68, END=70, HOME=72}
   ARROW_KEY_FLAG   = 1 << 8,
   ARROW_KEY_INT    = 91,
